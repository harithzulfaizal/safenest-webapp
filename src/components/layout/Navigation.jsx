...
import { User, BarChart2, List, LogIn, HelpCircle, ShieldPlus } from 'lucide-react';
...
export const Navigation = ({ currentPage, setCurrentPage, userProfile, onLogout }) => {
  ...
  return (
    <nav className="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 p-4 flex flex-col flex-shrink-0">
      <div className="mb-6">
      ...
      <div className="space-y-1.5 flex-grow">
        ...
        <NavItem page="transactions" label="Transactions" icon={List} />
      ...
      <div className="mt-auto pt-4 border-t border-gray-200 dark:border-gray-700">
        <div className="flex items-center mb-3">
          <User className="h-8 w-8 rounded-full bg-gray-200 dark:bg-gray-700 p-1 mr-2 text-gray-600 dark:text-gray-400"/>
          <div>
